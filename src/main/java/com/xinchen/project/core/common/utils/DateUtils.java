package com.xinchen.project.core.common.utils;
 ...
 * @version 1.0
 * @date Created In 2023/2/5 21:50
 */
public class DateUtils {
  ...
  public static Date getNowDayDate(){
    SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
    return stringToDate(dateFormat.format(getNowDate()),"yyyy-MM-dd");
  }
  /**
   * 获得当前时间前几天的日期
   * @param i 天数
  ...
  public static Date getBeforeDayDate(int i){
    ...
    SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
    return stringToDate(dateFormat.format(cal.getTime()),"yyyy-MM-dd");
  }
  /**
   * 获得某天23:59:59点时间
   * @return
